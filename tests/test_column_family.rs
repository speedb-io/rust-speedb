...
use speedb::{ColumnFamilyDescriptor, MergeOperands, Options, DB, DEFAULT_COLUMN_FAMILY_NAME};
use speedb::{TransactionDB, TransactionDBOptions};
use util::DBPath;
...
use speedb::MultiThreaded;
#[cfg(not(feature = "multi-threaded-cf"))]
use speedb::SingleThreaded;
...
fn test_no_leaked_column_family() {
    let n = DBPath::new("_rust_rocksdb_no_leaked_column_family");
    {
        ...
        let mut write_options = speedb::WriteOptions::default();
